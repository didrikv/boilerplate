...
let analyser = 
	<div className={styles.section}>
		<h3>Kjennetegn ved gode kulturkommuner</h3>
		<br/>
		<p>Hvert år siden 2011 har Telemarksforsking målt kulturnivået i norske kommuner. Tendensen over tid er slående: De samme kommunene rangerer i toppsjiktet år etter år. Hvorfor er det slik? Hva er det Røros gjør som Rødøy ikke gjør? Hvorfor har noen kommuner et godt kulturtilbud og en høy aktivitet innenfor kultursektoren – og andre ikke? Er det bevisste kulturpolitiske satsinger som ligger bak? Hva kan kommunene selv påvirke dersom de vil bedre det lokale kulturlivet – og hva kan de ikke gjøre noe med?</p>
		<p>Telemarksforsking forsker på hvilke strukturelle og kulturelle faktorer som har betydning for kulturtilbud og kulturaktivitet i norske kommuner. Denne kunnskapen skal brukes til å utvikle forklaringsmodeller for hva som kjennetegner gode kulturkommuner. Slike modeller kan være viktige utviklingsverktøy for norske kommuner og fylkeskommuner.</p>
		<br/>
...
let struktur = 
	<div className={styles.section}>
		...
		<br/>
		<p>De aller fleste kommuner og kulturadministrasjoner er opptatt av hvordan man kan legge til rette for kulturell aktivitet og, ikke minst, hva som skal til for å fremme en stor mengde kulturell aktivitet. Men selv om både kulturbyråkrater, politikere, lokale kreative næringer og frivillige gjør sitt beste for å fremme et levende kulturliv, kan vi anta at det finnes flere strukturelle forhold som ikke kan styres av kommunene, men som fremmer eller begrenser kulturnivået.</p>
		<br/>
