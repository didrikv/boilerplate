			...
			<Grid>
				<Row>
					<Col sm={3} style={{textAlign: 'center'}}>
						<p> <a target='_blank' href="https://www.telemarksforsking.no/medarbeidere/bard-kleppe/80/">Bård Kleppe</a> </p>
						<p> <a href="mailto:kleppe@tmforsk.no">kleppe@tmforsk.no</a> </p>
						<p>+47 911 97 543</p>
					</Col>
					<Col sm={3} style={{textAlign: 'center'}}>
						<p> <a target='_blank' href="https://www.telemarksforsking.no">Telemarksforsking</a> </p>
