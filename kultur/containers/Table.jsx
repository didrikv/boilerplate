		...
		<div>
			...
			<table className="tg">
				<tbody><tr>
					...
					<tr>
						<td className="tg-icwe" colSpan={3}>1 KUNSTNERE</td>
					</tr>
					<tr>
						<td className="tg-28d0">1a Kunstnertetthet</td>
						<td className="tg-28d0">Medlemsregister fra 10 kunstnerorganisasjoner</td>
					...
					<tr>
						<td className="tg-28d0">1c Tildelinger fra Statens kunstnerstipend</td>
						<td className="tg-28d0">Statens kunstnerstipend</td>
						<td className="tg-28d0">2,50 %</td>
					</tr>
					<tr>
						<td className="tg-icwe" colSpan={3}>2 KULTURARBEIDERE</td>
					</tr>
					<tr>
						<td className="tg-28d0">2a Sysselsatte innen kunstnerisk produksjon</td>
						<td className="tg-28d0">SSB sin sysselsettingsstatistikk (SN2007)</td>
					...
					<tr>
						<td className="tg-icwe" colSpan={3}>3 MUSEUM</td>
					</tr>
					<tr>
					...
					<tr>
						<td className="tg-icwe" colSpan={3}>4 MUSIKK</td>
					</tr>
					<tr>
						<td className="tg-28d0">4c Antall konserter billettselskaper</td>
						<td className="tg-28d0">Ticketmaster, Billettportalen, TicketCo, eBillett, Hoopla, Aurora, Ringbillett, Linticket og Tikkio </td>
						<td className="tg-28d0">5.00%</td>
					</tr>
					<tr>
						<td className="tg-28d0">4d Billettinntekter for konserter billettselskaper</td>
						<td className="tg-28d0">Ticketmaster, Billettportalen, TicketCo, eBillett, Hoopla, Aurora, Ringbillett, Linticket og Tikkio </td>
						<td className="tg-28d0">5.00%</td>
					</tr>
					<tr>
						<td className="tg-icwe" colSpan={3}>5 KINO</td>
					</tr>
					<tr>
					...
					<tr>
						<td className="tg-icwe" colSpan={3}>6 BIBLIOTEK</td>
					</tr>
					<tr>
						<td className="tg-28d0">6a Totalt utlån fra folkebibliotek (alle medier)</td>
						<td className="tg-28d0">Folkebibliotekstatistikk fra Nasjonalbiblioteket</td>
						<td className="tg-28d0">2,50%</td>
					</tr>
					<tr>
					...
					<tr>
						<td className="tg-28d0">6d Antall deltagere på arrangementer i folkebibliotekene</td>
						<td className="tg-28d0">Folkebibliotekstatistikk fra Nasjonalbiblioteket</td>
						<td className="tg-28d0">2,50 %</td>
					</tr>
					<tr>
						<td className="tg-icwe" colSpan={3}>7 SCENEKUNST</td>
					</tr>
					<tr>
						<td className="tg-28d0">7a Antall teaterforestillinger</td>
						<td className="tg-28d0">NTO statistikk + tilsendte lister fra regionteatre</td>
						<td className="tg-28d0">3,3 %</td>
					</tr>
					<tr>
					...
					<tr>
						<td className="tg-icwe" colSpan={3}>8 KULTUR FOR BARN</td>
					</tr>
					<tr>
						<td className="tg-95q0" colSpan={2}>KULTURSKOLE</td>
						<td className="tg-95q0">7,50 %</td>
					</tr>
					<tr>
						<td className="tg-28d0">8a Antall årstimer totalt i kulturskolen</td>
					...
					<tr>
						<td className="tg-28d0">8c Antall elever fra kommunen i kulturskole</td>
						<td className="tg-28d0">KOSTRA/SSB</td>
						<td className="tg-28d0">2,50 %</td>
					</tr>
					<tr>
						<td className="tg-95q0" colSpan={2}>DEN KULTURELLE SKOLESEKKEN</td>
					...
					<tr>
						<td className="tg-icwe" colSpan={3}>9 SENTRALE TILDELINGER</td>
					</tr>
					<tr>
						<td className="tg-28d0">9a Kulturfondtildelinger + tilskudd over statsbudsjettet</td>
					...
					<tr>
						<td className="tg-icwe" colSpan={3}>10 FRIVILLIGHET</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td className="tg-28d0">Norsk sangerforbund, Norges Korforbund, Norsk sangerforum, Ung i Kor og KOSTRA</td>
						<td className="tg-28d0">1,25 %</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td className="tg-28d0">VOX, nasjonalt fagorgan for kompetansepolitikk</td>
						<td className="tg-28d0">1,25 %</td>
					</tr>
					<tr>
