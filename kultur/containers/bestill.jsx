		...
		<Grid>
			<Row>
				<div className={styles.section}>
					...
					<p>En standard kommunerapport kan i 2017 produseres for kr 30.000 + mva. Vi utarbeider også en forenklet powerpoint-versjon for kr 10.000 + mva.</p>
					<p>Standard fylkesrapporter kan i 2017 produseres for kr 60.000 + mva. </p>
